  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Справочник кодов типов оборудования (например «cs» — коммутатор) для составных идентификаторов паспортов. Полный список — в инструкции по идентификации объектов ДИТ/И-05-28.2-16, таблица 2."
      />
      <Card>
        <CardHeader>
